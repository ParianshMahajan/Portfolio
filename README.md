...
- **Frontend**: React, Next.js, JavaScript, TypeScript, HTML, CSS, Material-UI, Tailwind CSS
- **Backend**: Node.js, Express.js, Spring Boot, Golang, Python
- **Databases**: MongoDB, PostgreSQL, Redis, Kafka
- **DevOps & Cloud**: Docker, Kubernetes, Jenkins, Nginx, AWS, GCP, Azure, Terraform
...
- Played a key role in **major college projects**, including the development of critical management systems signed by the university.
- Conducted and mentored **5+ hackathons**, fostering innovation and creativity among budding developers.
- Solved **400+ LeetCode** problems, demonstrating proficiency in data structures and algorithms.
- Joint Secretary of the **Creative Computing Society**, leading initiatives to promote tech culture across the campus.
...
- **Email**: [parianshm@gmail.com](mailto:parianshm@gmail.com)
