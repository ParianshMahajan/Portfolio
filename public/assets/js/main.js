...
async function fetchStats() {
	try {
	  ...
	  if (data.status) {
		...
		const totalLeetcodeQuestionsElement = document.getElementById('totalLeetcodeQuestions');
  
		if (totalCommitsElement && totalLeetcodeQuestionsElement) {
		  totalCommitsElement.setAttribute('data-count', data.commits);
		  totalLeetcodeQuestionsElement.setAttribute('data-count', data.solvedQuestions);
		}
